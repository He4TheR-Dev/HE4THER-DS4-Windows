...
This project **respects the original**: credits, license, and upstream lineage stay front and center. We donâ€™t replace DS4Windows â€” we stand on its shoulders.

---

## What it is

DS4Windows maps PlayStation controllers to an Xbox 360 virtual pad (via ViGEm), so games that only speak â€œXboxâ€ just work with DualShock 4 / DualSense.

| | |
|---|---|
| **Upstream** | [Ryochan7/DS4Windows](https://github.com/Ryochan7/DS4Windows) (official, archived â€” final release **3.3.3**) |
| **Lineage** | Scarlet.Crush â†’ [Jays2Kings/DS4Windows](https://github.com/Jays2Kings/DS4Windows) â†’ Ryochan7 |
| **This repo** | HE4THER custom distribution of that stack |
| **Runtime** | .NET 8 Â· Windows 10/11 |
...
- Built for players who want DS4Windows â€” with a HE4THER identity
...
If you want the **canonical source**, issues history, and upstream releases â€” go to the official repo first. HE4THER is a custom distribution layered on that work.
...
<p align="center">
  <b>Official DS4Windows Â· Custom HE4THER cut</b><br/>
  Plug in. Play harder.
</p>
